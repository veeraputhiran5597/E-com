...
const Kitchenapplinces=()=>
{
    ...
    {
        await axios
        .get("http://localhost:3000/Appliances")
          .then((response) => setkitchenArr(response.data))
    ...
    const filtersFunctions=()=>
      {
        let Filterarry=KitchenArr.map((ele)=>ele);
    ...
    const Mainmenu=()=>
    {
        return(
            <>
             <h1>Kitchen applinces</h1>
             <div className="Maincont" >
        {(filterArray.length===0?KitchenArr:filterArray).map((ele,ind)=>{
            return(
                <>
...
export default Kitchenapplinces;